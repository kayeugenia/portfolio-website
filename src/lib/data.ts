...
export const projectsData = [
    {
        title: "cineMOOD",
        description:
        "A full-stack web application that provides movie recommendations using semantic search and content-based filtering. Achieved highest level of achievement (Artemis), awarded to the top 5% groups.",
        tags: ["React", "Javascript", "CSS", "PostgreSQL", "Supabase", "Sentence-BERT", "Flask", "Python", "Material-UI"],
        imageUrl: "/images/cineMOOD.png",
        githubUrl: "https://github.com/kayeugenia/orbital-cinemood",
        webUrl: "https://www.youtube.com/watch?v=u80TqGn6L2M&ab_channel=PoonZheXuan",
    },
    {
        ...
        tags: ["React.js", "CSS", "Gurobi", "CLIP", "Sentence-BERT", "Flask", "Python"],
    ...
    },
    {
        ...
        githubUrl: "",
        webUrl: "https://drive.google.com/file/d/1KVKAttzn707f-AvDQstIUnZwkZYjdkpu/view"
    },
] as const;
...
export const experiencesData = [
    {
        ...
        skills: {"C#": "/images/csharp.png", "ASP.NET": "/images/aspnet.png", "Snowflake": "/images/snowflake.png", "SQL": "/images/sql.png", "Gitlab":"/images/gitlab.png"},
    ...
    },
    {
        ...
        skills: {"React": "/images/react.png", "JavaScript": "/images/javascript.png", "HTML": "/images/html.png", "CSS": "/images/css.png" },
