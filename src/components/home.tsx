		...
		<section ref={ref}>
			<div className="flex flex-col pt-0 sm:pt-4 md:justify-between lg:flex-row">
				...
				>
					...
					<div className="py-3">
						<TypeAnimation
							sequence={["Kay", 800, "Eugenia", 500, "Kay Eugenia"]}
							wrapper="span"
							className={`${inter.className} text-5xl font-bold text-gray-950 text-[3rem] sm:text-[4rem]`}
							speed={30}
							deletionSpeed={25}
						/>
					</div>
					<p
						className={`${inter.className} text-[1.5rem] sm:text-[2rem] text-zinc-400`}
					>
					...
					>
						<a
							...
							href="Resume-KayEugeniaPurnama.pdf"
							download
						>
							Download Resume{" "}
				...
				<motion.div
					className="flex items-center justify-center pt-3 px-5 lg:pt-0"
					initial={{ opacity: 0, scale: 0 }}
					animate={{ opacity: 1, scale: 1 }}
					transition={{
						type: "tween",
